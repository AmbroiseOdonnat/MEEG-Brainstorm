...
fig = plt.figure()
sns.boxplot(data=df.loc[(df["len_trials"] == 5)], x="transform", y=metric, palette="Set2")
sns.swarmplot(data=df.loc[(df["len_trials"] == 5)], x="transform", y=metric, hue="test_subject_id", palette="tab10")
plt.tight_layout()
